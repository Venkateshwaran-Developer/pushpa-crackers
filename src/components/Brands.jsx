...
function Brands() {
  ...
  return (
    <div id="Brands" className="brands bg-white text-black py-8 font-SpicyRice font-extralight">
    <div className="flex justify-center sm:text-[50px] md:text-[100px] font-SpicyRice  pb-3 ">
        Brands
    </div>
    <div className="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2  place-items-center gap-x-3 gap-y-10 ">
      {" "}
      <div className="  md:hover:shadow-2xl rounded-2xl h-64 w-80 gap-y-8  flex flex-col justify-center items-center  ">
