...
function OurServices() {
  return (
    ...
    <div className="flex justify-center font-SpicyRice font-extralight text-3xl  pb-3 ">
        Our Services
    </div>
    <div className="grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 place-items-center gap-x-3 gap-y-10 ">
      
      <div className="  rounded-2xl h-64 w-96 gap-x-8  flex justify-center items-center  ">
      ...
      <div className="   rounded-2xl h-64 w-96 gap-x-8 flex  justify-center items-center  ">
        ...
        <p className="text-sm font-SpicyRice font-extralight">Call us any time @+91 9944179753</p>
        </div>
      </div>
